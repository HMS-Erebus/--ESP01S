...
void blood_Loop(void)
{
	...
	//UsartPrintf(USART_DEBUG,"AT+MQTTPUB=0,\"/k0qbh9ZPUor/esp8266/user/get\",1,\"{\\\"heart_rate\\\":%3d}\"\r\n", g_blooddata.heart);
	OLED_ShowNum(4,7,g_blooddata.heart,3);
	UsartPrintf(USART_DEBUG,"指令血氧%0.2f",g_blooddata.SpO2);
	//UsartPrintf(USART_DEBUG,"AT+MQTTPUB=0,\"/k0qbh9ZPUor/esp8266/user/get\",1,\"{\\\"blood_oxygen\\\":%0.2f}\"\r\n", g_blooddata.SpO2);
